...
const MegaMenuInner = () => {
  ...
  const build = (items) => {
    ...
    const planItem = items[1];
    const utilitiesItem = items[2];
    ...
    return (
      <Fragment>
        ...
        <MenuItem key="plans">
          <MenuLink path={planItem.path} className={linkClass}>
            <MenuTitle className={titleClass}>{planItem.title}</MenuTitle>
          </MenuLink>
        </MenuItem>
        <MenuItem key="utilities">
          <MenuLink path={utilitiesItem.path} className={linkClass}>
            <MenuTitle className={titleClass}>{utilitiesItem.title}</MenuTitle>
          </MenuLink>
        </MenuItem>
